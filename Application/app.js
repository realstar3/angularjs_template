var app = angular
    .module('cogranApp', ['ngAnimate','ngMaterial','ui.router', 'ngSanitize', 'oc.lazyLoad']);
    ...
    $ocLazyLoadProvider.config({
        ...
        'modules': [{ // Set modules initially
            ...
            files: [
                ...
                'https://cdn.rawgit.com/daniel-nagy/md-data-table/master/dist/md-data-table.min.css',
